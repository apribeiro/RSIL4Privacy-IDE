 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getPartof <em>Partof</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getRefprivatedata <em>Refprivatedata</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getRefertoservice <em>Refertoservice</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getRefertoEnforcement <em>Referto Enforcement</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.InformativeImpl#getModalitykind <em>Modalitykind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InformativeImpl extends MinimalEObjectImpl.Container implements Informative
{
  ...
  {
    return MyDslPackage.Literals.INFORMATIVE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INFORMATIVE__NAME, oldName, name));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INFORMATIVE__DESCRIPTION, oldDescription, description));
  }
  ...
  public void setCondition(String newCondition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INFORMATIVE__CONDITION, oldCondition, condition));
  }
  ...
  public Informative getPartof()
  {
    if (partof != null && partof.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.INFORMATIVE__PARTOF, oldPartof, partof));
      }
    }
    return partof;
  }
  ...
  public void setPartof(Informative newPartof)
  {
    ...
    partof = newPartof;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INFORMATIVE__PARTOF, oldPartof, partof));
  }
  ...
  public EList<RefPrivateData> getRefprivatedata()
  {
    ...
    {
      refprivatedata = new EObjectContainmentEList<RefPrivateData>(RefPrivateData.class, this, MyDslPackage.INFORMATIVE__REFPRIVATEDATA);
    }
  ...
  public EList<ReferToService> getRefertoservice()
  {
    ...
    {
      refertoservice = new EObjectContainmentEList<ReferToService>(ReferToService.class, this, MyDslPackage.INFORMATIVE__REFERTOSERVICE);
    }
  ...
  public EList<RefertoEnforcement> getRefertoEnforcement()
  {
    ...
    {
      refertoEnforcement = new EObjectContainmentEList<RefertoEnforcement>(RefertoEnforcement.class, this, MyDslPackage.INFORMATIVE__REFERTO_ENFORCEMENT);
    }
  ...
  public void setModalitykind(String newModalitykind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INFORMATIVE__MODALITYKIND, oldModalitykind, modalitykind));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.INFORMATIVE__REFPRIVATEDATA:
        return ((InternalEList<?>)getRefprivatedata()).basicRemove(otherEnd, msgs);
      case MyDslPackage.INFORMATIVE__REFERTOSERVICE:
        return ((InternalEList<?>)getRefertoservice()).basicRemove(otherEnd, msgs);
      case MyDslPackage.INFORMATIVE__REFERTO_ENFORCEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.INFORMATIVE__NAME:
        return getName();
      case MyDslPackage.INFORMATIVE__DESCRIPTION:
        return getDescription();
      case MyDslPackage.INFORMATIVE__CONDITION:
        return getCondition();
      case MyDslPackage.INFORMATIVE__PARTOF:
      ...
      case MyDslPackage.INFORMATIVE__MODALITYKIND:
