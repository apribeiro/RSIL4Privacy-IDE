 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.ReferToRecipientImpl#getRefertore <em>Refertore</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferToRecipientImpl extends MinimalEObjectImpl.Container implements ReferToRecipient
{
  ...
  {
    return MyDslPackage.Literals.REFER_TO_RECIPIENT;
  }
    ...
    if (refertore != null && refertore.eIsProxy())
    {
      ...
      if (refertore != oldRefertore)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.REFER_TO_RECIPIENT__REFERTORE, oldRefertore, refertore));
      }
    }
    return refertore;
  }
  ...
  public void setRefertore(Recipient newRefertore)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.REFER_TO_RECIPIENT__REFERTORE, oldRefertore, refertore));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.REFER_TO_RECIPIENT__REFERTORE:
