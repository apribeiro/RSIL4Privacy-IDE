 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getRecipientname <em>Recipientname</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getPartof <em>Partof</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getRecipientScopeKind <em>Recipient Scope Kind</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RecipientImpl#getRecipientTypeKind <em>Recipient Type Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RecipientImpl extends MinimalEObjectImpl.Container implements Recipient
{
  ...
  {
    return MyDslPackage.Literals.RECIPIENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECIPIENT__NAME, oldName, name));
  }
  ...
  public void setRecipientname(String newRecipientname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECIPIENT__RECIPIENTNAME, oldRecipientname, recipientname));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECIPIENT__DESCRIPTION, oldDescription, description));
  }
  ...
  public EList<Partof> getPartof()
  {
    if (partof == null)
    {
      partof = new EObjectContainmentEList<Partof>(Partof.class, this, MyDslPackage.RECIPIENT__PARTOF);
    }
    return partof;
  }
  ...
  public void setRecipientScopeKind(String newRecipientScopeKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECIPIENT__RECIPIENT_SCOPE_KIND, oldRecipientScopeKind, recipientScopeKind));
  }
  ...
  public void setRecipientTypeKind(String newRecipientTypeKind)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RECIPIENT__RECIPIENT_TYPE_KIND, oldRecipientTypeKind, recipientTypeKind));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RECIPIENT__PARTOF:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.RECIPIENT__NAME:
        return getName();
      case MyDslPackage.RECIPIENT__RECIPIENTNAME:
        return getRecipientname();
      case MyDslPackage.RECIPIENT__DESCRIPTION:
        return getDescription();
      case MyDslPackage.RECIPIENT__PARTOF:
        return getPartof();
      case MyDslPackage.RECIPIENT__RECIPIENT_SCOPE_KIND:
        return getRecipientScopeKind();
      case MyDslPackage.RECIPIENT__RECIPIENT_TYPE_KIND:
