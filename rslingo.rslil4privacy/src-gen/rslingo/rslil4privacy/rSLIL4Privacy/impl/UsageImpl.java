 ...
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getPartUsage <em>Part Usage</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefPrivateData <em>Ref Private Data</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefPDAll <em>Ref PD All</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefService <em>Ref Service</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefSAll <em>Ref SAll</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefEnforcement <em>Ref Enforcement</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getRefEAll <em>Ref EAll</em>}</li>
 *   <li>{@link rslingo.rslil4privacy.rSLIL4Privacy.impl.UsageImpl#getModality <em>Modality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UsageImpl extends MinimalEObjectImpl.Container implements Usage
{
  ...
  /**
   * The cached value of the '{@link #getPartUsage() <em>Part Usage</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPartUsage()
   * @generated
   ...
   * @generated
   */
  public Usage getPartUsage()
  {
    if (partUsage != null && partUsage.eIsProxy())
    {
      InternalEObject oldPartUsage = (InternalEObject)partUsage;
      partUsage = (Usage)eResolveProxy(oldPartUsage);
      if (partUsage != oldPartUsage)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RSLIL4PrivacyPackage.USAGE__PART_USAGE, oldPartUsage, partUsage));
      }
    }
    return partUsage;
  }
   ...
   * @generated
   */
  public Usage basicGetPartUsage()
  {
    return partUsage;
  }
   ...
   * @generated
   */
  public void setPartUsage(Usage newPartUsage)
  {
    Usage oldPartUsage = partUsage;
    partUsage = newPartUsage;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__PART_USAGE, oldPartUsage, partUsage));
  }
  ...
  public NotificationChain basicSetRefPrivateData(RefPrivateData newRefPrivateData, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA, oldRefPrivateData, newRefPrivateData);
  ...
  public void setRefPrivateData(RefPrivateData newRefPrivateData)
  {
    if (newRefPrivateData != refPrivateData)
    {
      ...
      if (refPrivateData != null)
        msgs = ((InternalEObject)refPrivateData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA, null, msgs);
      if (newRefPrivateData != null)
        msgs = ((InternalEObject)newRefPrivateData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA, null, msgs);
      msgs = basicSetRefPrivateData(newRefPrivateData, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA, newRefPrivateData, newRefPrivateData));
  }
  ...
  public void setRefPDAll(String newRefPDAll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_PD_ALL, oldRefPDAll, refPDAll));
  }
  ...
  public NotificationChain basicSetRefService(RefService newRefService, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_SERVICE, oldRefService, newRefService);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRefService(RefService newRefService)
  {
    if (newRefService != refService)
    {
      NotificationChain msgs = null;
      if (refService != null)
        msgs = ((InternalEObject)refService).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_SERVICE, null, msgs);
      if (newRefService != null)
        msgs = ((InternalEObject)newRefService).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_SERVICE, null, msgs);
      msgs = basicSetRefService(newRefService, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_SERVICE, newRefService, newRefService));
  }
  ...
  public void setRefSAll(String newRefSAll)
  {
    ...
    refSAll = newRefSAll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_SALL, oldRefSAll, refSAll));
  }
  ...
  public NotificationChain basicSetRefEnforcement(RefEnforcement newRefEnforcement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT, oldRefEnforcement, newRefEnforcement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRefEnforcement(RefEnforcement newRefEnforcement)
  {
    if (newRefEnforcement != refEnforcement)
    {
      ...
      if (refEnforcement != null)
        msgs = ((InternalEObject)refEnforcement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT, null, msgs);
      if (newRefEnforcement != null)
        msgs = ((InternalEObject)newRefEnforcement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT, null, msgs);
      msgs = basicSetRefEnforcement(newRefEnforcement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT, newRefEnforcement, newRefEnforcement));
  }
  ...
  public void setRefEAll(String newRefEAll)
  {
    ...
    refEAll = newRefEAll;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__REF_EALL, oldRefEAll, refEAll));
  }
  ...
  public void setModality(String newModality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.USAGE__MODALITY, oldModality, modality));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA:
        return basicSetRefPrivateData(null, msgs);
      case RSLIL4PrivacyPackage.USAGE__REF_SERVICE:
        return basicSetRefService(null, msgs);
      case RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case RSLIL4PrivacyPackage.USAGE__CONDITION:
        return getCondition();
      case RSLIL4PrivacyPackage.USAGE__PART_USAGE:
        if (resolve) return getPartUsage();
        return basicGetPartUsage();
      case RSLIL4PrivacyPackage.USAGE__REF_PRIVATE_DATA:
        return getRefPrivateData();
      case RSLIL4PrivacyPackage.USAGE__REF_PD_ALL:
        return getRefPDAll();
      case RSLIL4PrivacyPackage.USAGE__REF_SERVICE:
        return getRefService();
      case RSLIL4PrivacyPackage.USAGE__REF_SALL:
        return getRefSAll();
      case RSLIL4PrivacyPackage.USAGE__REF_ENFORCEMENT:
        return getRefEnforcement();
      case RSLIL4PrivacyPackage.USAGE__REF_EALL:
        return getRefEAll();
      case RSLIL4PrivacyPackage.USAGE__MODALITY:
        return getModality();
    }
