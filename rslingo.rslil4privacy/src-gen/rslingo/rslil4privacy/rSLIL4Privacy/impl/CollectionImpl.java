...
public class CollectionImpl extends MinimalEObjectImpl.Container implements Collection
{
  ...
  public NotificationChain basicSetRefPrivateData(RefPrivateData newRefPrivateData, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_PRIVATE_DATA, oldRefPrivateData, newRefPrivateData);
  ...
  public void setRefPrivateData(RefPrivateData newRefPrivateData)
  {
    if (newRefPrivateData != refPrivateData)
    {
      ...
      if (refPrivateData != null)
        msgs = ((InternalEObject)refPrivateData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_PRIVATE_DATA, null, msgs);
      if (newRefPrivateData != null)
        msgs = ((InternalEObject)newRefPrivateData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_PRIVATE_DATA, null, msgs);
      msgs = basicSetRefPrivateData(newRefPrivateData, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_PRIVATE_DATA, newRefPrivateData, newRefPrivateData));
  }
  ...
  public NotificationChain basicSetRefService(RefService newRefService, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_SERVICE, oldRefService, newRefService);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRefService(RefService newRefService)
  {
    if (newRefService != refService)
    {
      NotificationChain msgs = null;
      if (refService != null)
        msgs = ((InternalEObject)refService).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_SERVICE, null, msgs);
      if (newRefService != null)
        msgs = ((InternalEObject)newRefService).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_SERVICE, null, msgs);
      msgs = basicSetRefService(newRefService, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_SERVICE, newRefService, newRefService));
  }
  ...
  public NotificationChain basicSetRefEnforcement(RefEnforcement newRefEnforcement, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_ENFORCEMENT, oldRefEnforcement, newRefEnforcement);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRefEnforcement(RefEnforcement newRefEnforcement)
  {
    if (newRefEnforcement != refEnforcement)
    {
      ...
      if (refEnforcement != null)
        msgs = ((InternalEObject)refEnforcement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_ENFORCEMENT, null, msgs);
      if (newRefEnforcement != null)
        msgs = ((InternalEObject)newRefEnforcement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RSLIL4PrivacyPackage.COLLECTION__REF_ENFORCEMENT, null, msgs);
      msgs = basicSetRefEnforcement(newRefEnforcement, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RSLIL4PrivacyPackage.COLLECTION__REF_ENFORCEMENT, newRefEnforcement, newRefEnforcement));
  }
